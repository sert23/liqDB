...
class DisplayStudy(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        log_w.write("Start "+datetime.now().strftime("H%:M%:S")+"\n")
        ...
        log_w.write("RNAcol loaded " + datetime.now().strftime("H%:M%:S") + "\n")
        ...
        log_w.write("DE_plot " + datetime.now().strftime("H%:M%:S") + "\n")
        ...
        for e in headerLine.rstrip().split("\t"):
            ...
            column_list.append(new_dict)
            #print(e)
        log_w.write("json_loop " + datetime.now().strftime("H%:M%:S") + "\n")
        ...
        log_w.write("sample_loop " + datetime.now().strftime("H%:M%:S") + "\n")
